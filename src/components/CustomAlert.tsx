...
export default function CustomAlert({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] p-4 backdrop-blur-sm animate-in fade-in-0 duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-4 duration-300" style={{ animation: 'bounce-in 0.5s cubic-bezier(0.68, -0.55, 0.265, 1.55)' }}>
        {/* Header with Icon */}
