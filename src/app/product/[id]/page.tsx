...
export default function ProductDetailPage() {
  ...
  const handleAddToCart = async () => {
    ...
    setTimeout(() => {
      ...
      alert(`✅ ${product?.name} berhasil ditambah ke cart!`);
    }, 500);
  };
    ...
    <div className="min-h-screen bg-gray-50">
                  ...
                  >
                    {isAddingToCart ? (
                      <>
                        ...
                        <span className="text-xl">MENAMBAH...</span>
                      </>
                    ) : (
                      <>
      ...
      {showPaymentModal && product && (
        <PaymentModal
          ...
          productName={`${product.name} (Size: ${selectedSize})`}
          ...
          onPaymentSuccess={() => {
            ...
            // Refresh products to show sold status
